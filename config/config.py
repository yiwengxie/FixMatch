...
def get_config():
    ...
    parser.add_argument('--dataset', default='flowers102', type=str, choices=['cifar10', 'cifar100', 'flowers102', 'cars196', 'birds200'], help='dataset name')
    ...
    parser.add_argument('--lambda-g', default=1, type=float, help='coefficient of generated loss')
    ...
    parser.add_argument('--generated', action='store_true', default=False, help='train the model with generated data')
    ...
    parser.add_argument('--three', action='store_true', default=False, help='train the model with three data')
